...
def create_decoder(opt, embedding, emo_embedding, mode):
    decoder_type = opt.decoder_type
    rnn_type = opt.rnn_type
    atten_model = opt.atten_model
    input_size = opt.embedding_size
    emo_embedding_size = 0
    if opt.use_emo_emb:
        emo_embedding_size = opt.emo_embedding_size
...
def create_base_model(opt, fields, mode='train'):
    ...
    decoder = create_decoder(opt, dec_embedding, emo_embedding, mode)

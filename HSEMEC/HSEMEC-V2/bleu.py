...
if __name__ == '__main__':
    ...
    # references_with_source_file = os.path.join('../ECM/data', 'NLPCC2017', 'valid_4866.txt')
    # mark = 'enlpcc2017_test_25'
    # generate_mark = 'enlpcc2017_test_25_4866'

    references_with_source_file = os.path.join('../ECM/data', 'NLPCC2017_95W', 'test.txt')
    mark = 'test_13_2'
    generate_mark = 'test_13_2'
    ...
    for i in range(15,18):
        modelID = str(i)
        """MemGM"""
        # back_up = '../backup_MemoryAugDialog'
        uniq_translation_file = os.path.join('result', f'res_gene_{mark}_tdv22_epoch{modelID}_{generate_mark}')
        # uniq_translation_file = os.path.join('..', 'ECM', 'result', 'NLPCC2017_95W','ecm_no_pretrain_goon', f'epoch_{i}_with_emo')
        # uniq_translation_file = os.path.join(f'../EmoDS/result3/result_epoch_{i}.txt')

        """ECM"""
        # uniq_translation_file = os.path.join('..', 'ECM', 'result', 'ESTC', f'seq2seq_with_emo')

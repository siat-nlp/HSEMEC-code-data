...
def get_data(data_dir, post_vocabulary_size, response_vocabulary_size):
    ...
    try:
        ...
        vocab_response = load_vocab(
            os.path.join(data_dir, config.get('data', 'response_vocab_file') % response_vocabulary_size))
...
def get_ememory(data_dir, response_vocabulary_size):
    ...
    vocab_response, _ = initialize_vocabulary(
        os.path.join(data_dir, config.get('data', 'response_vocab_file') % response_vocabulary_size))
